...
// What if we have a tie? Our code would actually give the win to Jamie, which is no good. 
// Add in an else if to resolve this.
if(jonSnowAttack > jamieLannisterAttack) {
    console.log('Jon has a greater attack');
}
else if(jonSnowAttack === jamieLannisterAttack) {
    console.log('They are even match');
}
else {
    console.log('Jon has a greater attack');
}
...
if(jonSnowHealth +50 >= 100) {
    console.log("Jon's health is maxed")
}
else {
    jonSnowHealth += 50
}
